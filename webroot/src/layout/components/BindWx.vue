...
<template>
  <NModal :show="visible" style="width: 50%; max-width: 500px" :on-after-enter="openDialog" :on-after-leave="handleCloseDialog">
    <div class="p-5   rounded dark:bg-[#15171A] bg-[#ffffff]">
