...
import {fetchGetMemberAgreementAPI, queryCopyRight} from "@/api/global";
...
async function queryCopyright() {
	...
	const res = await fetchGetMemberAgreementAPI({keys: ['copyrightTitle','icpNumber','policeFilingNumber','icpUrl','policeFilingUrl']})
...
<template>
  <div class="copy-container">
		...
		<div style="color: #eeeeee">
			<p>版权所有 © {{formData.copyrightTitle}}
