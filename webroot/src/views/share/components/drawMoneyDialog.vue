...
<template>
	<NModal class="dark:bg-[#15171A] bg-[#FFFFFF]" :show="visible" style="width: 90%; max-width: 500px"
					:on-after-enter="openDialog" :on-after-leave="handleCloseDialog">
				...
				>
					<NFormItem path="withdrawalAmount" label="提款金额">
						<div class="dark:bg-[#010102] bg-[#f4f4f4] w-full">
							<NInputNumber  v-model:value="orderForm.withdrawalAmount" class="w-full"
														clearable :precision="2" placeholder="请填写提款金额"/>
						</div>
					</NFormItem>
