...
function withdrawClick(){
	...
	drawMoneyVisibleDialog = true
}
</script>

<template>
<!--  <div class="main bg-[#f8f8fb] min-h-screen bg-center dark:bg-[#1F1F38]">-->
  <div style="margin-top: 20px" class="main bg-[#F4F4F4] bg-center dark:bg-[#010102]">
    ...
    <div class="flex-1 flex-wrap py-5 flex justify-between" :class="[isMobile ? 'px-3' : 'px-20']">
      <div class="px-[12px] min-w-[350px]" :class="[isMobile ? 'w-full' : 'w-1/3']">
        ...
        <div class="w-full bg-[#f78400] p-6 flex flex-col justify-between rounded shadow-xl relative">
          ...
          <div class="flex justify-between text-[#fff] items-center">
            ...
            <div>
              ...
              >
                <template #trigger>
                  <div class="btn " :class="[inviteAccount?.distributionBalance < Number(salesBaseRatio) ? 'disabled' : '']" @click=" withdrawClick">
                    立即提现
                  </div>
                </template>
        ...
        <!-- 数据统计 -->
        <div class="flex flex-col bg-[#fff] mt-5 rounded dark:bg-[#15171A]  px-2">
      ...
      <div class="px-[12px]" :class="[isMobile ? 'w-full' : 'w-2/3']">
        <!-- 推荐链接 -->
        <div class="bg-[#fff]  dark:bg-[#15171A] p-5 rounded flex">
          <div class="w-full flex ">
            ...
            <div ref="selectable" class="bg-[#F4F4F4] dark:bg-[#010102] flex-1 flex items-center  dark:border-[#ffffff17] border-b border-t pl-4 max-w-[500px] select-text overflow-x-hidden whitespace-nowrap">
              {{ inviteUrl }}
            </div>
        ...
        <!-- 推荐记录 -->
        <div class="mt-5 bg-[#fff] p-5 dark:bg-[#15171A]">
          <NTabs ref="tabRef"
    ...
    <NModal :show="inviteDialog" style="width: 90%; max-width: 420px">
      <div class="p-4 bg-white rounded dark:bg-slate-800">
        ...
        <div class="w-full flex mb-5 px-6">
          <NInputGroup class="dark:bg-[#010102] bg-[#f4f4f4]">
