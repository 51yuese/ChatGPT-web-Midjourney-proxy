...
<template>
  <div class="main bg-center  h-[92vh] flex flex-col overflow-hidden ">
    <TitleBar title="会员商场" :des="tips" :class="[isMobile ? 'px-3' : 'px-24']" />
    <div class=" flex justify-center items-center" :style="{ height: isMobile ? '60px' : '100px' }">
    ...
    <div class="flex-1 pb-10 overflow-y-auto h-4/5" :class="[isMobile ? 'px-3' : 'px-28']">
