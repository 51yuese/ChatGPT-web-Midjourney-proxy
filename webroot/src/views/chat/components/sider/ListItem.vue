...
<template>
  <div style="background-color:#3076ED ;"></div>
  ...
  <div v-for="item of dataSources" :key="`${item.uuid}`">
    <a
      class="bg-[#fff] dark:bg-[#171726] relative flex items-center dark:border-transparent  border-gray-200 gap-3 px-3 py-2.5 break-all border rounded-md cursor-pointer  hover:bg-gradient-to-l dark:to-[#54A2F5]  hover:dark:text-[#2D6DD9]  group "
      :class="[isActive(item.uuid) ? ' dark:text-[#2D6DD9] text-[#3378ED] bg-gradient-to-l border-transparent bg-[#ebe9e9] dark:bg-[#15171A] pr-20' : 'dark:bg-[#1A1D21]']"
