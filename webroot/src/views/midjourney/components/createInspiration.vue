...
const handleGoPrompt = () => {
  ...
  EventBus.emit("selectIncantation",selectIncantation.value)
  show.value = false;
}
	...
	>
		...
		<div class="flex justify-between">
						...
						<li v-for="item in listData.level2">
							...
							<div class="my-1" v-if="item.children.length > 0">
								<div v-for="subItem in item.children" :key="subItem.id"
										 class="inline-block rounded mr-2 mb-2 text-[12px] dark:bg-[#202B3A] bg-[#A0A0A0] py-[2px] px-[6px]"
			...
			<div class="w-2/12 h-full  flex flex-col">
				...
				<div class="dark:bg-[#202B3A] dark:border-gray-600 border bg-[#F7F7F7] h-[470px] rounded p-2">
