...
async function getRankingList() {
	const res =  await fetchQueryAppsByTypeAPI({type:'latest'});
	if (res.code == 200){
		...
		<div class="title">
			<div>
				<svg style="margin-right: 10px" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
					<path d="M7.08335 7.5H3.66669C2.56212 7.5 1.66669 8.39543 1.66669 9.5V17.5H7.08335V7.5Z" stroke="#A3A5A6" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M12.5 4.5C12.5 3.39543 11.6045 2.5 10.5 2.5H9.08331C7.97874 2.5 7.08331 3.39543 7.08331 4.5V17.5H12.5V4.5Z" stroke="#A3A5A6" stroke-width="1.67" stroke-linejoin="round"/>
					<path d="M17.9167 12.8333C17.9167 11.7287 17.0212 10.8333 15.9167 10.8333H12.5V17.5H17.9167V12.8333Z" stroke="#A3A5A6" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
				</svg>
			</div>
			<div class="dark:text-[#F4F4F4] text-[#03060C]">应用排行</div>
		</div>

		<div class="ranking_list">
			<div class="hot_list">
<!--				<div style="color: #2960BE;font-size: 15px">热门榜</div>-->
				<div class="hot_item dark:bg-[#1A1D21] bg-[#FFF]" v-for="item in rankingList" :key="item.id">
					<div style="width: 100%">
							...
							<div style="width: 100%">
								<div style="width: 100%;display: flex;align-items: center;justify-content: space-between">
									...
									<div style="display: flex;align-items: center;">
										...
										<div class="attempt_btn dark:bg-[#2960BE] bg-[#3378ED] dark:text-[#FFF] text-[#FFF]" @click="createChat(item.id)">立即使用</div>
									</div>
								</div>
