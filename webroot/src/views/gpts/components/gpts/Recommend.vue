...
import {fetchCollectAppAPI, fetchQueryAppChatListAPI, fetchQueryAppsByTypeAPI} from "@/api/appStore";
...
async function getRecommendList() {
	const res =  await fetchQueryAppsByTypeAPI({type:'recommend'});
	if (res.code == 200){
...
<template>
	<div class="recommend_app">
		<div class="title">
			<div>
				<svg style="margin-right: 10px" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
					<path d="M6.77904 2.09329H3.73252C2.81205 2.09329 2.06586 2.83948 2.06586 3.75996V6.80648C2.06586 7.72695 2.81205 8.47314 3.73252 8.47314H6.77904C7.69952 8.47314 8.44571 7.72695 8.44571 6.80648V3.75996C8.44571 2.83948 7.69952 2.09329 6.77904 2.09329Z" stroke="#A3A5A6" stroke-width="1.67"/>
					<path d="M6.77904 11.3871H3.73252C2.81205 11.3871 2.06586 12.1333 2.06586 13.0538V16.1003C2.06586 17.0207 2.81205 17.7669 3.73252 17.7669H6.77904C7.69952 17.7669 8.44571 17.0207 8.44571 16.1003V13.0538C8.44571 12.1333 7.69952 11.3871 6.77904 11.3871Z" stroke="#A3A5A6" stroke-width="1.67"/>
					<path d="M16.1255 11.3871H13.079C12.1585 11.3871 11.4124 12.1333 11.4124 13.0538V16.1003C11.4124 17.0207 12.1585 17.7669 13.079 17.7669H16.1255C17.046 17.7669 17.7922 17.0207 17.7922 16.1003V13.0538C17.7922 12.1333 17.046 11.3871 16.1255 11.3871Z" stroke="#A3A5A6" stroke-width="1.67"/>
					<path d="M16.1255 2.09329H13.079C12.1585 2.09329 11.4124 2.83948 11.4124 3.75996V6.80648C11.4124 7.72695 12.1585 8.47314 13.079 8.47314H16.1255C17.046 8.47314 17.7922 7.72695 17.7922 6.80648V3.75996C17.7922 2.83948 17.046 2.09329 16.1255 2.09329Z" stroke="#A3A5A6" stroke-width="1.67"/>
				</svg>
			</div>
			<div class="dark:text-[#F4F4F4] text-[#03060C]">推荐应用</div>
		</div>
		<div class="app_list">
			<div class="app_item dark:bg-[#1A1D21] bg-[#FFF]" v-for="item in RecommendList" :key="item.id">
				<div>
				...
				<div style="width: 100%">
					<div class="title_card">
						<div style="display: flex;align-items: center;">
							<div style="font-size: 16px;margin-right: 5px">{{item.modelName}}</div>
							<div class="title_tag dark:bg-[#1C2F1E] bg-[#EAFAE6] dark:text-[#2ECD06] text-[#2ECD06]" v-if="item.gptsApp == true">gpts</div>
						</div>
						<div>
