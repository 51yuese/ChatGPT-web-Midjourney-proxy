...
<!--  </div>-->
	...
	<div
		ref="messageRef"
		class="flex w-full mb-6 overflow-hidden items-start mt-5">
		<div
			class=" flex-shrink-0 mt-2 ml-8"
			:class="[inversion ? 'ml-2' : 'mr-2']"
		>
			<AvatarComponent :image="inversion" />
		</div>
		<div style="width: 100%" class="overflow-hidden text-sm " :class="[inversion ? 'items-end' : 'items-start']">
			<div
				class="flex items-end gap-1 mt-2"
				:class="[inversion ? 'flex-row-reverse' : 'flex-row']"
			>
