...
<template>
<!--	dark:bg-[#010102] bg-[#F4F4F4]-->
  <div style="margin-top: 10px; height: calc(100% - 10px);" class="flex grow flex-col sm:flex-row h-full">
    <div style="margin-left: 10px; margin-right: 20px; border-radius: 20px; height: calc(100% - 70px);" class="asc sm:pt-4 box-border bg-[#FFFFFF] h-[90%] dark:bg-[#15171A] overflow-y-auto w-full sm:w-[20rem] shrink-0 border-r-2 border-[#ffffff17] flex flex-col ">
    ...
    <div style="border-radius: 20px;margin-right: 10px; height: calc(100% - 70px)" class="h-full flex-1 overflow-y-auto overflow-hidden min-h-[80vh] flex flex-col bg-[#FFFFFF] dark:bg-[#15171A]">
