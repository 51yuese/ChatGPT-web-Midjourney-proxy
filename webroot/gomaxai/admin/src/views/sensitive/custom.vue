...
<template>
  <div>
    ...
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline">
        ...
        <el-form-item label="敏感词状态" prop="status">
          <el-select v-model="formInline.status" placeholder="请选择敏感词状态" clearable style="width: 192px;">
    ...
    <page-main v-loading="loading" style="width: 100%;" bottomPadding="20px" bottomMargin="0px">
      <el-tag
