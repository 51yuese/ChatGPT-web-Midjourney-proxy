...
<template>
  <div>
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline">
        ...
        <el-form-item label="检测平台" prop="typeOriginCn">
          <el-select v-model="formInline.typeOriginCn" placeholder="请选择检测平台" clearable style="width: 192px;">
    ...
    <page-main   bottomPadding="20px" bottomMargin="0px">
      <el-table v-loading="loading" border :data="tableData" height="67vh" style="width: 100%;" size="large" :tooltip-options="{}">
