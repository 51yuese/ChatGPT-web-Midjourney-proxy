...
async function queryAllconfig() {
  const res = await apiConfig.queryConfig({ keys: ['siteName', 'qqNumber', 'vxNumber', 'robotAvatar', 'userDefautlAvatar', 'buyCramiAddress', 'siteRobotName', 'isShowAppCatIcon'] })
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="网站名称" prop="siteName">
              <el-input v-model="formInline.siteName" placeholder="网站名称【GoMaxAi】" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
