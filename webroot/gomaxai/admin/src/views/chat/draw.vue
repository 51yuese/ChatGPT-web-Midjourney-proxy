...
<template>
  <div>
    <page-main bottomPadding="20px">
      <el-alert :closable="false" show-icon title="DALL-E2绘画说明" description="此处的midjourney模型选择是老版本的历史数据、新版迁移至新菜单分开！" type="success" />
    </page-main>
    ...
    <page-main v-loading="loading" style="width: 100%;" bottomPadding="20px">
