  ...
  <div>
    ...
    <div id="login-box">
      ...
      <el-form v-show="formType === 'login'" ref="loginFormRef" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on">
        ...
        <div class="flex-bar">
          <el-checkbox v-model="loginForm.remember" style="color: #fafafa">
            记住我
          </el-checkbox>
        ...
        <el-button :loading="loading" type="primary" size="large" style="width: 100%; font-size: 18px; background: #70c1ff; height: 42px;" @click.prevent="handleLogin">
          登录
        </el-button>
        <div class="sub-link">
