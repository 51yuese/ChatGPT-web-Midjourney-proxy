...
const dialogTitle = computed(() => {
  return activeAppCatId.value ? '更新App' : '新增App'
})
  ...
  formEl?.validate(async (valid) => {
    if (valid) {
      if (activeAppCatId.value) {
        ...
        ElMessage({ type: 'success', message: '创建应用成功！' })
      }
      visible.value = false
      queryAppList()
    }
...
<template>
  <div>
    ...
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline">
        <el-form-item label="App分类" prop="catId">
          <el-select v-model="formInline.catId" placeholder="请选择App分类" clearable style="width: 192px;">
            <el-option v-for="item in catList" :key="item.id" :label="item.name" :value="item.id" />
          </el-select>
        </el-form-item>
        <el-form-item label="App状态" prop="status">
          <el-select v-model="formInline.status" placeholder="请选择App状态" clearable style="width: 192px;">
        ...
        <el-form-item label="App角色" prop="status">
          <el-select v-model="formInline.role" placeholder="请选择App角色" clearable style="width: 192px;">
    ...
    <el-dialog v-model="visible" :close-on-click-modal="false" :title="dialogTitle" width="900" @close="handlerCloseDialog(formPackageRef)">
      <el-form
        ref="formPackageRef"
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            ...
            <el-form-item label="App预设" prop="preset">
              <el-input v-model="formPackage.preset" type="textarea" placeholder="请填写App介绍信息、用于对外展示..." :rows="4" />
            </el-form-item>
            <el-form-item label="App描述" prop="des">
              <el-input v-model="formPackage.des" type="textarea" placeholder="请填写App介绍信息、用于场景内置信息..." :rows="4" />
            </el-form-item>

          </el-col>
          <el-col :span="12">
            <el-form-item v-if="!isUserApp" label="App启停" prop="status">
              <el-switch
