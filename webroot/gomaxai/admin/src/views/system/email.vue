...
async function queryAllconfig() {
  const res = await apiConfig.queryConfig({ keys: ['registerBaseUrl', 'registerVerifyEmailTitle', 'registerVerifyEmailFrom', 'registerVerifyEmailDesc', 'registerVerifyExpir', 'registerSuccessEmailTitle', 'registerSuccessEmailTeamName', 'registerSuccessEmaileAppend', 'registerFailEmailTitle', 'registerFailEmailTeamName', 'emailRegisterStatus'] })
...
<template>
  <div>
    <page-main bottomPadding="20px">
      <el-alert :closable="false" show-icon title="邮件设置说明" description="这里的邮件设置是作用于注册发送的激活邮件、您需要先在服务的root.config.yml文件中配置邮件服务信息、后续将迁移至此。" type="success" />
    </page-main>
      ...
      <el-form ref="formRef" :rules="rules" :model="formInline" label-width="190px">
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="是否开启邮箱登录" prop="emailRegisterStatus">
              <el-tooltip
                class="box-item"
                effect="dark"
                content="如您启用当前邮箱登录、则用户端可以通过邮箱注册或登录！"
                placement="right"
              >
                <el-switch
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册验证码下发邮件标题" prop="registerVerifyEmailTitle">
              <el-input v-model="formInline.registerVerifyEmailTitle" placeholder="默认标题: GoMaxAi团队验证码" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册验证码下发邮件来源" prop="registerVerifyEmailFrom">
              <el-input v-model="formInline.registerVerifyEmailFrom" placeholder="邮件尾部来源 From: (默认： GoMaxAiTeam)" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册时下发邮件详细内容" prop="registerVerifyEmailDesc">
              <el-input v-model="formInline.registerVerifyEmailDesc" type="textarea" :rows="3" placeholder="默认内容(欢迎使用GoMaxAiTeam团队AI团队的产品服务,请在三十分钟内完成你的账号激活,点击以下按钮激活您的账号) | 发送的邮件内容、会追加一个激活按钮、详细内容请查看文档。    " clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册成功通知页标题内容" prop="registerSuccessEmailTitle">
              <el-input v-model="formInline.registerSuccessEmailTitle" placeholder="默认标题: GoMaxAiTeam团队账户激活成功" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册成功通知页团队名称" prop="registerSuccessEmailTeamName">
              <el-input v-model="formInline.registerSuccessEmailTeamName" placeholder="邮件尾部来源 From: (默认： GoMaxAiTeam)" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册失败通知页标题内容" prop="registerFailEmailTitle">
              <el-input v-model="formInline.registerFailEmailTitle" placeholder="默认标题: GoMaxAiTeam团队账户激活失败" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册失败通知页团队名称" prop="registerFailEmailTeamName">
              <el-input v-model="formInline.registerFailEmailTeamName" placeholder="邮件尾部来源 From: (默认： GoMaxAiTeam)" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
