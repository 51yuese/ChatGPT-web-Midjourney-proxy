...
<template>
  <div>
    ...
    <el-card style="margin: 20px 20px 0 20px;">
      ...
      <div style="height: 59vh; overflow-y: auto; overflow-x: hidden">
      <el-form ref="formRef" :rules="rules" :model="formInline" label-width="230px">
        <el-row>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="是否自动降级" prop="openaiaAtoDowngrade" label-width="130">
              <el-tooltip
                class="box-item"
                effect="dark"
