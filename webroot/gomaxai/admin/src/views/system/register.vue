...
<template>
  <div>
    <page-main bottomPadding="20px">
      <el-alert :closable="false" show-icon title="注册设置说明" description="可以设置注册赠送的默认额度、包含对话次数、普通绘画额度、MJ绘画额度、并且可以设置前x名用户获得更多额度、包含设置邀请和被邀请次数等！" type="success" />
    </page-main>
    <el-card style="margin: 20px 20px 0 20px;">
      ...
      <div style="height: 61vh; overflow-y: auto; overflow-x: hidden">
        <el-form ref="formRef" :rules="rules" :model="formInline" label-width="214px" >
          <h5>邮件校验状态</h5>
          <el-row>
          ...
          <el-row>
            <el-col :xs="24" :md="20" :lg="15" :xl="12">
              <el-form-item label="注册赠送MJ绘画额度" prop="registerSendDrawMjCount" :rules="registerSendRules">
          ...
          <el-row>
            <el-col :xs="24" :md="20" :lg="15" :xl="12">
              <el-form-item label="优先赠送MJ绘画额度" prop="firstRregisterSendDrawMjCount" :rules="firstSendRules">
          ...
          <el-row>
            <el-col :xs="24" :md="20" :lg="15" :xl="12">
              <el-form-item label="邀请赠送MJ绘画额度" prop="inviteGiveSendDrawMjCount" :rules="inviteRules">
          ...
          <el-row>
            <el-col :xs="24" :md="20" :lg="15" :xl="12">
              <el-form-item label="被邀请赠送MJ绘画额度" prop="invitedGuestSendDrawMjCount" :rules="inviteRules">
                <el-input v-model="formInline.invitedGuestSendDrawMjCount" placeholder="被邀请注册用户赠送MJ额度" clearable />
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
