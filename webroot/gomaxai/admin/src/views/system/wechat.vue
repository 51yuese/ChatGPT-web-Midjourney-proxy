...
async function queryAllconfig() {
  const res = await apiConfig.queryConfig({ keys: ['wechatOfficialName', 'wechatOfficialAppId', 'wechatOfficialToken', 'wechatOfficialAppSecret', 'officialSubscribeText', 'officialBindAccountText', 'officialScanLoginText', 'officialAutoReplyText', 'wechatRegisterStatus', 'wechatSilentLoginStatus', 'WE_MiNI_APPID', 'WE_MINI_APPSECRET'] })
...
<template>
  <div>
    ...
    <el-card style="margin: 20px 20px 0 20px;">
      ...
      <div style="height: 58vh; overflow-y: auto; overflow-x: hidden">

      <el-form ref="formRef" :rules="rules" :model="formInline" label-width="170px">
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="是否开启微信扫码注册" prop="wechatRegisterStatus">
              <el-tooltip
                class="box-item"
                effect="dark"
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="小程序APPID" prop="WE_MiNI_APPID">
              <el-input v-model="formInline.WE_MiNI_APPID"  placeholder="请输入小程序APPID" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="小程序APPSECRET" prop="WE_MINI_APPSECRET">
              <el-input v-model="formInline.WE_MINI_APPSECRET" show-password placeholder="请输入小程序APPSECRET" vis clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
