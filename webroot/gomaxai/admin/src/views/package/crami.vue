...
const rules = reactive<FormRules>({
  ...
  drawMjCount: [{ required: true, message: '卡密携带MJ绘画数量', trigger: 'blur' }],
...
<template>
  <div>
    ...
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline">
        ...
        <el-form-item label="卡密状态" prop="status">
          <el-select v-model="formInline.status" placeholder="请选择卡密状态" clearable style="width: 192px;">
    ...
    <page-main bottomPadding="20px" bottomMargin="0px">
      <el-table v-loading="loading" border :data="tableData" height="calc(100vh - 310px)" style="width: 100%;" size="large" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="useId" label="使用人ID" width="100" />
        ...
        <el-table-column prop="drawMjCount" label="MJ额度" />
    ...
    >
      ...
      >
        ...
        <div v-if="customCrami">
          ...
          <el-form-item label="MJ绘画额度" prop="drawMjCount">
            <el-input v-model.number="form.drawMjCount" type="number" placeholder="卡密携带MJ绘画额度" />
          </el-form-item>
        </div>
