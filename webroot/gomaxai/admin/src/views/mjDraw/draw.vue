...
<template>
  <div>
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline">
        <el-form-item label="推荐状态" prop="rec">
          <el-select v-model="formInline.rec" placeholder="请选择推荐状态" clearable style="width: 192px;">
        ...
        <el-form-item label="绘制状态" prop="status">
          <el-select v-model="formInline.status" placeholder="请选择绘制状态" clearable style="width: 192px;">
    ...
    <page-main bottomPadding="20px" bottomMargin="0px">
      <el-table v-loading="loading" border :data="tableData" height="54vh" style="width: 100%;" size="large">
        <el-table-column prop="id" align="center" label="ID" width="70" />
        <el-table-column prop="fileInfo.thumbImg" align="center" label="绘图结果">
          <template #default="scope">
            <el-image style="height: 120px;" preview-teleported fit="contain" :preview-src-list="[scope.row?.imageUrl]" :src="scope.row?.imageUrl" lazy hide-on-click-modal />
          </template>
        </el-table-column>
