    ...
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline">
        <el-form-item label="工单状态" prop="orderStatus">
          <el-select v-model="formInline.orderStatus" placeholder="请选择工单状态" clearable style="width: 192px;">
        ...
        <el-form-item label="提现渠道" prop="withdrawalChannels">
          <el-select v-model="formInline.withdrawalChannels" placeholder="请选择提现渠道" clearable style="width: 192px;">
