  ...
  <div>
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline">
        ...
        <el-form-item label="充值类型" prop="rechargeType">
          <el-select v-model="formInline.rechargeType" placeholder="请选择充值类型" clearable style="width: 192px;">
    ...
    <page-main bottomPadding="20px" bottomMargin="0px">
      <el-table v-loading="loading"  border height="66vh" :data="tableData" style="width: 100%;" size="large">
        ...
        <el-table-column prop="drawMjCount" label="MJ余额额度" width="120" align="center" />
        <el-table-column prop="model3Dis" label="本次基础模型变更" width="120" align="center" />
        <el-table-column prop="model4Dis" label="本次高级模型变更" width="120" align="center" />
        <el-table-column prop="drawMjDis" label="本次MJ余额变更" width="120" align="center" />
