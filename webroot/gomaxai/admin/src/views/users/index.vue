...
const rules = reactive<FormRules>({
  ...
  drawMjCount: [{ required: true, message: '请填写赠送MJ绘画额度', trigger: 'blur' }],
})
  ...
  <div>
    <page-main>
      <el-form ref="formRef" :inline="true" :model="formInline">
        <el-form-item label="关键字" prop="keyword">
          <el-input v-model="formInline.keyword" placeholder="账号/邮箱/手机号/昵称" clearable />
        </el-form-item>
        <el-form-item label="用户状态" prop="status">
          <el-select v-model="formInline.status" placeholder="请选择用户状态" clearable style="width: 192px;">
    ...
    <page-main bottomPadding="20px" bottomMargin="0px">
      <el-table v-loading="loading" border height="66vh" :data="tableData" style="width: 100%;" size="large">
        ...
        <el-table-column prop="phone" label="用户手机号" width="250" align="center" />
        <el-table-column prop="email" label="用户邮箱" width="250" align="center" />
        ...
        <el-table-column prop="balanceInfo.drawMjCount" label="MJ余额" width="120" align="center" />expirationTime
        ...
        <el-table-column prop="balanceInfo.memberModel3Count" label="基础模型[会员]" width="130" align="center" />
        <el-table-column prop="balanceInfo.memberModel4Count" label="高级模型[会员]" width="130" align="center" />
        <el-table-column prop="balanceInfo.memberDrawMjCount" label="MJ余额[会员]" width="130" align="center" />
        ...
        <el-table-column prop="balanceInfo.useDrawMjToken" label="已用绘画MJ" width="160" align="center">
          <template #default="scope">
