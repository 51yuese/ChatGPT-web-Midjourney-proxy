...
<template>
  <div class="flex grow flex-col sm:flex-row h-full">
    <div class="sm:pt-4 box-border bg-[#E7ECF6]  dark:bg-[#18181c] overflow-y-auto w-full sm:w-[20rem] shrink-0 border-r-2 border-[#ffffff17] flex flex-col ">
    ...
    <div class="h-full flex-1 overflow-y-auto overflow-hidden min-h-[80vh] flex flex-col">
			...
			<div class="flex-1 w-full p-4 ">
				<svg ref="svgRef" class="box-border  w-full h-full border-2 rounded-md " />
			</div>
    </div>
  </div>
</template>
