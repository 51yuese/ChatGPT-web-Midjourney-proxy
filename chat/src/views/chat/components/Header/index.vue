            ...
            <template #trigger>
              <button class="flex h-8 w-8 items-center justify-center rounded border transition hover:bg-[#eef0f3] dark:border-neutral-700 dark:hover:bg-[#33373c]">
                <span class="text-base text-slate-500 dark:text-slate-400">
                  <SvgIcon icon="ph:thermometer-cold" />
                </span>
              </button>
            </template>
            <div style="height: 280px; width: 80px;" class="tem">
              <NSlider :default-value="temperature" :marks="marks" reverse vertical step="mark" :max="1.6" :on-update:value="handleUpdateTem" />
            </div>
          </NPopover> -->
